    ...
    <div className="app-shell">
      <header className="app-header">
        <div>
          ...
          <p>Search products, manage cart, and use the admin panel.</p>
        </div>
        <nav>
      ...
      <main className="app-main">
        ...
        {currentView === 'cart' && (
          <Cart items={cart} onUpdateQuantity={updateQuantity} onRemoveItem={removeFromCart} onClearCart={clearCart} />
        )}
